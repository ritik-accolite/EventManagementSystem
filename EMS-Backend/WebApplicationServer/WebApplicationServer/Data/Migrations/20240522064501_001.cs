        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChiefGuest = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EventDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Event_Time = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    EventOrganizerId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookedEvents", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_BookedEvents_AspNetUsers_EventOrganizerId",
                        column: x => x.EventOrganizerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookedEvents_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookedEvents_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedEvents_EventOrganizerId",
                table: "BookedEvents",
                column: "EventOrganizerId");

            migrationBuilder.CreateIndex(
                name: "IX_BookedEvents_UserId",
                table: "BookedEvents",
                column: "UserId");
